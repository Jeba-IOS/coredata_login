...
class ViewController: BaseViewController {
    ...
    func postAPICall(name:String,email:String,mobile:String,gender:String) {
        ...
        AF.request("https://crudcrud.com/api/c97ffe72651e49599a64872330ca344c/jeba",
                   method: .post,
...
//    }
    ...
    func PUTAPICall(name:String,email:String,mobile:String,gender:String) {
        ...
        AF.request("https://crudcrud.com/api/c97ffe72651e49599a64872330ca344c/jeba/\(DetailDict.id)",
                   method: .put,
                   parameters: parameters,
                   encoding: JSONEncoding.default, // Encode parameters as JSON
                   headers: headers)
